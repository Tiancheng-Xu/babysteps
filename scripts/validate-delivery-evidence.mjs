...
const expectedDiagramAssets = [
	{
		...
		minimumWidth: 2200,
		minimumHeight: 1400,
		markers: ["Browser SDK", "Cloudflare Worker", "Origin Token", "API Gateway", "SQS 主队列", "SQS DLQ", "一次性 ECS Fargate Cleaner", "共享 PostgreSQL", "p50 / p75 / p95", "GitHub Actions + OIDC", "项目栈自动清理", "AWS 闭环已验证", "Run 31765573258"],
	},
	{
		...
		minimumWidth: 2200,
		minimumHeight: 1400,
		markers: ["01 采集", "02 批量上报", "03 异步入队", "04 ECS 清洗", "05 真实统计", "06 Evidence 与清理", "sendBeacon", "失败静默", "maxReceiveCount = 3", "幂等写入", "sampleCount", "DROP SCHEMA", "delete-stack", "Run 31765573258", "ECS exitCode=0"],
	},
	{
